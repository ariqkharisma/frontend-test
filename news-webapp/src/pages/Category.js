...
function Category() {
  ...
  const { articles } = useSelector(state => {return state.news.newsCategory})
    ...
    return (
        <Fragment>
            ...
            <section id="main" style={{ minHeight: "calc(100vh - 131px)" }}>
                <h1 style={{margin: '36px 16px', borderBottom: "5px solid #124559", padding: '2px', width: 'fit-content'}}>{location.pathname.slice(1).toLocaleUpperCase()}</h1>
                <Row gutter={[16, 16]} style={{ margin: "8px" }}>
                    ...
                    <>
                        <Skeleton style={{ marginBottom: "32px", marginInline: '16px' }} active />
                        <Skeleton style={{ marginBottom: "32px", marginInline: '16px' }} active />
                        <Skeleton style={{ marginBottom: "32px", marginInline: '16px' }} active />
                    </>
                    }
